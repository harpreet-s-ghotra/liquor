...
Tests reorder-to-purchase-order handoff behavior, including distributor preselection, prefilled costs, and case-based quantity math.
...
| 2   | Press F6                    | Manager modal opens                          |
| 3   | Click Reorder Dashboard tab | Reorder dashboard loads                      |
...
| #   | Step                                          | Assertion                              |
| --- | --------------------------------------------- | -------------------------------------- |
| 1   | Open Reorder Dashboard and click Create Order | Purchase order create view is visible  |
...
| 4   | Locate Cases for Cabernet Sauvignon 750ml     | Cases input defaults to 1             |
